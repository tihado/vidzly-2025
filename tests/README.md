...
The integration tests use the real video file from `tests/data/dodo.MOV`:
...
- **Integration tests** use the real video file `tests/data/dodo.MOV` to test actual functionality
