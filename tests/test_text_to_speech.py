...
class TestTextToSpeechSimple:
    ...
    def test_basic_text_to_speech(self, tmp_path, monkeypatch):
        ...
        with patch('gtts.gTTS', mock_gtts_class):
            ...
            monkeypatch.setattr('src.app.tools.text_to_speech.Path', lambda x: tmp_path / x if 'outputs/audio' in x else Path(x))
...
Welcome to the tutorial."""
    ...
    def test_json_subtitle_conversion(self, tmp_path, monkeypatch):
        ...
        json_content = '{"scenes": [{"dialogue": "First line"}, {"dialogue": "Second line"}]}'
...
Line three."""
    ...
    def test_combined_options(self, tmp_path, monkeypatch):
        ...
        with patch('gtts.gTTS', mock_gtts_class):
            ...
            result = text_to_speech_simple("Bonjour", voice="female", language="fr", speed="slow")
...
Today we will learn something new."""
        ...
        with patch('gtts.gTTS', mock_gtts_class):
            ...
            result = text_to_speech_simple(srt_content, format_type='srt', generate_segments=True)
...
Second subtitle here."""
        ...
        with patch('gtts.gTTS', mock_gtts_class):
            ...
            result = text_to_speech_simple(vtt_content, format_type='vtt', generate_segments=True)
    ...
    def test_json_timed_segments(self, tmp_path, monkeypatch):
        ...
        with patch('gtts.gTTS', mock_gtts_class):
            ...
            result = text_to_speech_simple(json_content, format_type='json', generate_segments=True)
...
Auto-detected SRT."""
        ...
        with patch('gtts.gTTS', mock_gtts_class):
            ...
            result = text_to_speech_simple(srt_content, format_type='auto', generate_segments=True)
    ...
    def test_plain_text_with_segments_returns_single_file(self, tmp_path, monkeypatch):
        ...
        with patch('gtts.gTTS', mock_gtts_class):
            ...
            result = text_to_speech_simple("Plain text", format_type='text', generate_segments=True)
    ...
    def test_empty_subtitle_segments(self, tmp_path, monkeypatch):
        ...
        with patch('gtts.gTTS', mock_gtts_class):
            ...
            assert len(result_data['segments']) == 2
            assert result_data['segments'][0]['dialogue'] == 'Scene 1'  # Placeholder for empty dialogue
